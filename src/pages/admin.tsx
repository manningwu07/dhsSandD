...
const AdminInterface: React.FC = () => {
  ...
  const handleAdd = (key: string) => {
    setJsonData((prevData: JsonData) => ({
      ...prevData,
      [key]: [...prevData[key], { title: 'New Item', description: 'Description' }],
    }))
  }
    ...
    if (typeof value === 'string') {
      ...
      return (
        <div key={key} className="mb-4">
          ...
          <Button onClick={() => handleAdd(key)} variant="outline" size="sm" className="mt-2">
      ...
      return (
        <div key={key} className="mb-4" style={{ marginLeft: `${depth * 20}px` }}>
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <ScrollArea className="w-1/3 bg-white p-6 shadow-md">
        ...
        {Object.entries(jsonData).map(([key, value]) => renderEditField(key, value))}
      </ScrollArea>
      <div className="w-2/3 bg-gray-200 p-6 relative">
